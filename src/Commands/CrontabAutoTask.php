...
namespace Dcat\Admin\Extension\Crontab\Commands;

use Illuminate\Console\Command;
use Dcat\Admin\Extension\Crontab\Models\Crontab;
use Dcat\Admin\Extension\Crontab\Models\CrontabLog;
...
class CrontabAutoTask extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'Crontab:AutoTask';
            ...
            try {
                ...
                switch ($value['type']) {
                    ...
                    case 'shell':
                        ...
                        $process = new Process(explode(' ', $value['contents']));
                        $process->run();
